...
class FixedBackjumpForgettingPlanner:
    """Definition of planner.
    """
    def __init__(self, seed, timeout, heuristic_name, num_samples_per_step, fixed_step, learner_name=None):
        self._seed = seed
    ...
    def _sample_continuous_values(self, env, start_state, skeleton,
        ...
        while cur_idx < len(skeleton):
            ...
            while num_tries[cur_idx] == idx_to_max_num_tries[cur_idx]:
                backjump_idx = cur_idx - self._fixed_step
                cur_idx -= 1
                if cur_idx < 0:
